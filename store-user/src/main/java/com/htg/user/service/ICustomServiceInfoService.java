...
public interface ICustomServiceInfoService extends IService<CustomServiceInfo> {
    ...
    CommonResult<RespPage<CustomServiceUserInfoVo>> searchCustomSerivce(Page<CustomServiceUserInfoVo> page, String tel, String serviceName, String realName);
    ...
    CommonResult<RespId> addCustomService(CustomServiceUserDTO serviceUserDTO);
}
