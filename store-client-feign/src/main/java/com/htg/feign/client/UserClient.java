...
public interface UserClient {
    ...
    @GetMapping("/seller_info/get_seller_by_sn/{sellerSN}")
    SellerInfo getSellerBySN(@PathVariable("sellerSN") String  sellerSN);


    @GetMapping("/seller_info/get_enterprise_by_sn/{sellerSN}")
    SellerEnterpriseInfo getSellerEnterpriseInfoBySN(@PathVariable("sellerSN") String  sellerSN);
